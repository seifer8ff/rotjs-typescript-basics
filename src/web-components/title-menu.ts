...
import { SlIconButton, SlMenuLabel } from "@shoelace-style/shoelace";
...
export class TitleMenu extends HTMLElement {
  ...
  constructor() {
    ...
    // info.style.fontWeight = "var(--sl-font-weight-light)";
    // info.style.letterSpacing = "var(--sl-letter-spacing-normal)";
    info.textContent =
